\chapter{PREDIÇÃO DE CINTILAÇÃO IONOSFÉRICA COM ANTECEDÊNCIA HORÁRIA}\label{ch:revisonrezende}
...
\subsection{Metodologia para a reprodução do trabalho anterior}
...
\subsection{Resultados da classificação para o trabalho anterior}
...
\subfigure[fig:classoik2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-original/classification_kfold_original_958_1742_importance.eps}}
}
...
\subfigure[fig:classoii2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-original/classification_intime_original_958_1742_importance.eps}}
}
...
\subfigure[fig:classv1ik2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-v1/classification_kfold_v1_899_1635_importance.eps}}
}
\caption{Resultados para o problema de classificação utilizando de validação cruzada com 10 subconjuntos para os novos atributos. Fonte: próprio autor.}
...
\subfigure[fig:classv1ii2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost]{\includegraphics[width=9.5cm]{./Figuras/results-v1/classification_intime_v1_899_1635_importance.eps}}
}
\caption{Resultados para o problema de classificação utilizando de validação com separação no tempo para os novos atributos. Fonte: próprio autor.}
...
\subfigure[fig:classv1wik2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-v1/classification_kfold_v1-without-sl_2627_4778_importance.eps}}
}
...
\subfigure[fig:classv1wii2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-v1/classification_intime_v1-without-sl_2627_4778_importance.eps}}
}
...
\center
\makebox[\textwidth][c]{
\subfigure[fig:regall1][Validação cruzada com 10 subconjuntos.]{\includegraphics[width=9.5cm]{./Figuras/results-all-stations/regression_kfold_all_1982_3604_importance.eps}}
}
...
\subfigure[fig:classallik2][Importância relativa dos atributos obtida no treinamento realizado pelo XGBoost.]{\includegraphics[width=9.5cm]{./Figuras/results-all-stations/classification_kfold_all_2088_3797_importance.eps}}
}
