...
\titulo{Predição da cintilação ionosférica na região da Anomalia de Ionização Equatorial no território brasileiro}
\title{Ionospheric Scintillation Prediction in the Equatorial Ionization Anomaly region in the Brazilian territory}
\author{Pedro Alexandre dos Santos} %% coloque o nome do(s) autor(es)
\descriccao{Monografia para Exame de Proposta do Curso de Pós-Graduação em Computação Aplicada, orientada pelo Dr. Stephan Stephany, aprovada em 9 de agosto de 2019.}
