...
%\include{./docs/doc_aux/epigrafe} %% Opcional
%\include{./docs/doc_aux/dedicatoria} %% Opcional
%\include{./docs/doc_aux/agradecimentos} %% Opcional
\include{./docs/doc_aux/resumo} %% obrigatório
\include{./docs/doc_aux/abstract} %% obrigatório
...
\include{./docs/doc_aux/abreviaturasesiglas} %% opcional %% altere o arquivo siglaseabreviaturas.tex

%\include{./docs/doc_aux/simbolos} %% opcional %% altere o arquivo simbolos.tex

\includeSumario  %% obrigatório, gerado automaticamente

\inicioIntroducao %% não altere este comando

\include{./docs/doc_body/introduction}
\include{./docs/doc_body/chapter1}
\include{./docs/doc_body/chapter2}
\include{./docs/doc_body/chapter3}
\include{./docs/doc_body/chapter4}
\include{./docs/doc_body/chapter5}
